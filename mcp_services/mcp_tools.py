    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "transform_x": {"type": "number", "default": 0, "description": "水平位置偏移（应用于所有视频）"},
                "transform_y": {"type": "number", "default": 0, "description": "垂直位置偏移（应用于所有视频）"},
                "scale_x": {"type": "number", "default": 1, "description": "水平缩放倍数（应用于所有视频）"},
                "scale_y": {"type": "number", "default": 1, "description": "垂直缩放倍数（应用于所有视频）"},
                "track_name": {"type": "string", "default": "video_main", "description": "轨道名称"},
                "relative_index": {"type": "integer", "default": 0, "description": "相对排序索引"},
                "transition": {"type": "string", "description": "转场效果类型"},
                "transition_duration": {"type": "number", "default": 0.5, "description": "转场时长（秒）"},
                "volume": {"type": "number", "default": 1.0, "description": "音量增益"},
                "intro_animation": {"type": "string", "description": "入场动画效果"},
                "intro_animation_duration": {"type": "number", "default": 0.5, "description": "入场动画时长"},
                "outro_animation": {"type": "string", "description": "出场动画效果"},
                "outro_animation_duration": {"type": "number", "default": 0.5, "description": "出场动画时长"},
                "combo_animation": {"type": "string", "description": "组合动画效果"},
                "combo_animation_duration": {"type": "number", "default": 0.5, "description": "组合动画时长"},
                "mask_type": {"type": "string", "description": "蒙版形状类型"},
                "mask_center_x": {"type": "number", "default": 0.5, "description": "蒙版中心X坐标"},
                "mask_center_y": {"type": "number", "default": 0.5, "description": "蒙版中心Y坐标"},
                "mask_size": {"type": "number", "default": 1.0, "description": "蒙版大小"},
                "mask_rotation": {"type": "number", "default": 0.0, "description": "蒙版旋转角度"},
                "mask_feather": {"type": "number", "default": 0.0, "description": "蒙版羽化程度"},
                "mask_invert": {"type": "boolean", "default": False, "description": "是否反转蒙版"},
                "mask_rect_width": {"type": ["number", "null"], "default": None, "description": "矩形蒙版宽度"},
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "fixed_width": {"type": "number", "default": 0.9, "description": "文本框固定宽度比例。范围：0.0-1.0（相对画布宽度）。-1表示不固定宽度（自动适应）"},
                "fixed_height": {"type": "number", "default": -1, "description": "文本框固定高度比例。范围：0.0-1.0（相对画布高度）。-1表示不固定高度（自动适应）"},
...
<<<<<<< Updated upstream:mcp/mcp_tools.py
                "shadow_alpha": {"type": "number", "default": 0.76, "description": "阴影不透明度。范围：0.0-1.0。0.0为完全透明，1.0为完全不透明。"},
                "shadow_angle": {"type": "number", "default": -54.0, "description": "阴影投射角度。范围：-180.0至180.0（度）。"},
                ...
                "shadow_smoothing": {"type": "number", "default": 0.22, "description": "阴影平滑度（模糊程度）。范围：0.0-1.0。0.0为锐利，1.0为最柔和。"},
=======
                "shadow_alpha": {"type": "number", "default": 0.76, "description": "阴影不透明度。范围：0.0-1.0。0.0为完全透明，1.0为完全不透明。默认值：0.76"},
                "shadow_angle": {"type": "number", "default": -54.0, "description": "阴影投射角度。范围：-180.0至180.0（度）。-54.0表示左上方"},
                "shadow_color": {"type": "string", "default": "#000000", "description": "阴影颜色。十六进制格式：#RRGGBB"},
                "shadow_distance": {"type": "number", "default": 5.0, "description": "阴影距离。数值越大阴影越远。默认值：5.0"},
                "shadow_smoothing": {"type": "number", "default": 0.22, "description": "阴影平滑度（模糊程度）。范围：0.0-1.0。0.0为锐利，1.0为最柔和。数值越大阴影越柔和。默认值：0.22"},
>>>>>>> Stashed changes:mcp_tools.py
                ...
                "italic": {"type": "boolean", "default": False, "description": "是否斜体。应用于Text_style。与bold/underline互斥"},
