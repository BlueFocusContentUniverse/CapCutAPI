...
class VideoCharacterEffectType(EffectEnum):
    ...
    局部马赛克 = EffectMeta(
        ...
        "7034092576726585869",
        "1454112",
        "6f37c16b7d7904bc8489e66455f6d78b",
        [
            EffectParam("effects_adjust_range", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_size", 0.500, 0.000, 1.000),
        ],
    ...
    幽灵 = EffectMeta(
        ...
        "7000630410275197470",
        "1378554",
        "9f6758469c2a948cadfbeff53bbc5b6d",
        [
            EffectParam("effects_adjust_speed", 0.330, 0.000, 1.000),
            EffectParam("effects_adjust_color", 1.000, 0.000, 1.000),
        ],
    ...
    手印涂抹 = EffectMeta(
        ...
        "7153950763348136478",
        "5190085",
        "c617ff4e68e61de777f52149851b782c",
        [EffectParam("effects_adjust_intensity", 1.000, 0.000, 1.000)],
    )
    """参数:
    effects_adjust_intensity: 默认100%, 0% ~ 100%"""
    手绘描边 = EffectMeta(
        ...
        "7406177019404227109",
        "80106342",
        "07d72dd2e34f4fd41cbdabe05464454d",
        [],
    )
    打击 = EffectMeta(
        "打击",
    ...
    掉小珍珠啦 = EffectMeta(
        ...
        "7132336135748981255",
        "4080159",
        "91cb59a743f8089684fcf7c420861e74",
        [],
    )
    故障描边_I = EffectMeta(
        "故障描边 I",
    ...
    日系大头贴 = EffectMeta(
        ...
        "7309039877796925978",
        "32668223",
        "04f1ebf5bf63743f1bb12f518ede4b5e",
        [
            EffectParam("effects_adjust_intensity", 1.000, 0.000, 1.000),
            EffectParam("effects_adjust_texture", 0.800, 0.000, 1.000),
    ...
    氛围大头贴 = EffectMeta(
        ...
        "7309480138486321715",
        "32919263",
        "13daa7e7f44f245155737d4a8017d0e2",
        [
            EffectParam("effects_adjust_intensity", 1.000, 0.000, 1.000),
            EffectParam("effects_adjust_texture", 0.800, 0.000, 1.000),
            EffectParam("effects_adjust_blur", 0.100, 0.000, 1.000),
    ...
    潮流入侵 = EffectMeta(
        ...
        "7039588403897176583",
        "1475552",
        "fff9a2112e2f1befcbe793a348d9b49e",
        [
            EffectParam("effects_adjust_size", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_speed", 0.330, 0.000, 1.000),
    ...
    灵魂出走 = EffectMeta(
        ...
        "6994263736991093278",
        "1220234",
        "b78e2e42d51b354ad3a2c9af04da43f1",
        [
            EffectParam("effects_adjust_speed", 0.330, 0.000, 1.000),
    ...
    狼人 = EffectMeta(
        ...
        "7156899280374993416",
        "5413619",
        "f3d6cf02114d17bad33a3003557f5ff5",
        [
            EffectParam("effects_adjust_filter", 0.800, 0.000, 1.000),
    ...
    神明少女 = EffectMeta(
        ...
        "6906817277316829703",
        "1169466",
        "20a22b74a6a7a30f2dcab48dbc5276b6",
        [
    ...
    迷茫 = EffectMeta(
        ...
        "6979931594408595975",
        "1185225",
        "19618c1e22b607642e7b27dc2602832f",
        [
            EffectParam("effects_adjust_size", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_vertical_shift", 0.500, 0.000, 1.000),
        ],
    ...
    鼻血 = EffectMeta(
        ...
        "7153900212623249950",
        "5182539",
        "fc3d1f3cca541ced7f24b226eff114ee",
        [EffectParam("effects_adjust_intensity", 1.000, 0.000, 1.000)],
    )
    """参数:
    effects_adjust_intensity: 默认100%, 0% ~ 100%"""
    ...
    吸血鬼 = EffectMeta(
        ...
        "7154356694376518158",
        "5226581",
        "c560f8982d276a2824147698951751cd",
        [
            EffectParam("effects_adjust_color", 0.000, 0.000, 1.000),
            EffectParam("effects_adjust_texture", 1.000, 0.000, 1.000),
            EffectParam("effects_adjust_filter", 1.000, 0.000, 1.000),
    ...
    哥特 = EffectMeta(
        ...
        "7154061273838129672",
        "5199947",
        "94bd5a2ec19553d8e91423ab41b1bfee",
        [
    ...
    天使 = EffectMeta(
        ...
        "7156481333189939720",
        "5374123",
        "14336b246c295332eee8b29c5dc807c4",
        [
            EffectParam("effects_adjust_texture", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_size", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_number", 0.500, 0.000, 1.000),
    ...
    撕纸拼贴 = EffectMeta(
        ...
        "7406207253583237682",
        "80787899",
        "e2b5e11e2f24940b65c91615723613f6",
        [],
    )
    旋转分身 = EffectMeta(
        "旋转分身",
    ...
    涂鸦鬼影 = EffectMeta(
        ...
        "7153917024723276325",
        "5185037",
        "9570d183c3973de1498c638834c5136d",
        [
            EffectParam("effects_adjust_color", 0.000, 0.000, 1.000),
            EffectParam("effects_adjust_filter", 1.000, 0.000, 1.000),
        ],
    ...
    电光描边_II = EffectMeta(
        ...
        "7265989852099777061",
        "20444547",
        "3a3aee848d3e7c13822281957ef09093",
        [
    ...
    轮廓扫描 = EffectMeta(
        ...
        "7260773990178755129",
        "19351962",
        "82f3b4a76091dda533a0ca1b0b2265e8",
        [
            EffectParam("effects_adjust_color", 0.600, 0.000, 1.000),
            EffectParam("effects_adjust_speed", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_rotate", 0.000, 0.000, 1.000),
    ...
    闪光放大 = EffectMeta(
        ...
        "7304912977180758537",
        "33838202",
        "a64dcdf7a22d382739051486535a4704",
        [
            EffectParam("effects_adjust_speed", 0.330, 0.000, 1.000),
            EffectParam("effects_adjust_intensity", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_luminance", 0.600, 0.000, 1.000),
    ...
    霓虹爱心 = EffectMeta(
        ...
        "7194734553288675895",
        "9221893",
        "cf3b121f71539f6fc039062473db7c43",
        [
            EffectParam("effects_adjust_speed", 0.500, 0.000, 1.000),
            EffectParam("effects_adjust_filter", 0.500, 0.000, 1.000),
        ],
    ...
    高光人物 = EffectMeta(
        ...
        "7406179353362436645",
        "80107647",
        "4264ef0b6e1ada149ba0580b36001e2c",
        [],
    )
    黑色眼泪 = EffectMeta(
        "黑色眼泪",
        ...
        "7154231632604434981",
        "5208347",
        "0343aabd4b0ef59cc829bd1732be0bbd",
        [
            EffectParam("effects_adjust_intensity", 0.800, 0.000, 1.000),
            EffectParam("effects_adjust_filter", 0.800, 0.000, 1.000),
        ],
